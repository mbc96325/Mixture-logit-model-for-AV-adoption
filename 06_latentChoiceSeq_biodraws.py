...
# data['Income_in_U'] = 0
# data.loc[data.INCOME==12,'Income_in_U'] = 0
# data.loc[data.INCOME==1,'Income_in_U'] = 1000
# data.loc[data.INCOME==2,'Income_in_U'] = 3000
# data.loc[data.INCOME==3,'Income_in_U'] = 5000
# data.loc[data.INCOME==4,'Income_in_U'] = 7000
# data.loc[data.INCOME==5,'Income_in_U'] = 9000
# data.loc[data.INCOME==6,'Income_in_U'] = 11000
# data.loc[data.INCOME==7,'Income_in_U'] = 13500
# data.loc[data.INCOME==9,'Income_in_U'] = 17500
# data.loc[data.INCOME==23,'Income_in_U'] = 25000
# data['Income_in_U'] = data['Income_in_U']/1000 #scale
...
Variable_name = ['age_60_more','Chinese','male','fulltimeJob','age_35_less','highEducation',
                 'kid_under18','Commute','intercept']
...
BETA_SOCIO = {}
modes_list = ['PT','RH','AV','Drive'] # no need for defining walk, benchmark

# socio_in_U = {'EDU':EDU,'Income_in_U':Income_in_U,'AGE':AGE}

socio_in_U = {'Income_4000_less':Income_4000_less,'Income_12000_more':Income_12000_more,'moreThanOneCar':moreThanOneCar,
              'haveLicense':haveLicense,'Single':Single}
...
for att in attitude_name:
    ...
    for mode in modes_list:
        #mode = 'AV'
        beta_name = 'BETA_' + att +'_to_' + mode # only consider attitude towards AV
...
biogeme  = bio.BIOGEME(database, loglike, numberOfThreads = 22, numberOfDraws = 2000, seed = 1)
biogeme.modelName = "Latent_Choice_seq_biodraws"
