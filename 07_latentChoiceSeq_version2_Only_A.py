...
data = pd.read_csv("../data/data_Standalong_LV.csv")
# define variables
...
socio_in_U = {'Income_4000_less':Income_4000_less,'Income_12000_more':Income_12000_more,
              ...
              'moreThanOneCar':moreThanOneCar,'male':male, 'fulltimeJob':fulltimeJob,'age_35_less':age_35_less, 'kid_under18':kid_under18,
...
mode = 'Walk'
V_def[mode] += BETA_ATTITUDE[att][mode] * struc_equ[att]
# V_def[mode] += random_variable[mode]['sigma_s'] * random_variable[mode]['omega']  # normalize to zero
...
biogeme  = bio.BIOGEME(database, loglike, numberOfThreads = 4, numberOfDraws = 2000, seed = 1)
biogeme.modelName = "Latent_Choice_seq_LV_only_A"
